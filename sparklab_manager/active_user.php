...
// Retrieve check-in data for the current date
$sql = "SELECT * FROM check_in WHERE DATE(check_in_date) = '$currentDate'";
$result = $conn->query($sql);
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary" onclick="viewTransaction(<?php echo $row['id']; ?>)">View</button>
                    </td>
                </tr>
                <?php
            }
            ...
            ?>
            <tr>
                <td colspan="6">No check-ins for today.</td>
            </tr>
            <?php
        }
        ?>
