...
$result = $conn->query($sqlSubscribers);
...
<html
  ...
  <head>
    ...
    <title>Subscribers | Spark Lab Hub </title>
  ...
  <body>
    ...
    <tbody>
        <?php foreach ($subscribers as $subscriber) : ?>
            <tr>
                <td><img class="w-px-50 h-100 rounded-circle" src="<?php echo $subscriber['profile_photo']; ?>" alt="<?php echo $subscriber['full_name']; ?>"></td>
                <td><?php echo $subscriber['full_name']; ?></td>
                <td><?php echo $subscriber['email']; ?></td>
                <td><?php echo $subscriber['area_of_interest']; ?></td>
                <td>
